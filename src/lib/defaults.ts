...
export const DEFAULT_SITE: SiteContent = {
  hero: {
    ...
    titleHl: "穩穩接住",
    titleC: "。",
    lead: "白露協會以「助人工作者的自我照顧」為願景出發，致力營造長期提供助人服務的友善環境，一同向光而行。",
  },
  about: {
    lead: "白露：初秋微涼，小小水珠逐步凝結，清晨而起也能見得遍布滋養大地。",
    intro:
      "本會於中華民國114年8月11日經內政部許可設立，並於114年12月26日完成法人登記（臺灣新竹地方法院登記字第1239號）。本會為依法設立、非以營利為目的之公益性社會團體，以提升社工自我照顧與量能、為弱勢群體提供支援與關懷為宗旨。",
    origin1:
  ...
  footerTagline:
    "以「助人工作者的自我照顧」為願景出發，致力營造長期提供助人服務的友善環境，一同向光而行。",
};
...
export const DEFAULT_NEWS: NewsItem[] = [
  ...
  },
  {
    ...
    body: "台灣白露社會福利服務協會誠摯邀請您加入。我們是一個專注於社工照顧與弱勢關懷的非營利組織，期待與您一同為社會福利盡一份心力。歡迎個人、團體與贊助會員加入，詳細申請流程請來信 tw.whitedew@gmail.com 洽詢。",
  },
  {
    id: sid("n"),
    date: "2025-03-05",
